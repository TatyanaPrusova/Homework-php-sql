...
$work_experience = [
    [
       ...
       'period' => '17.01.2018 - current',
       'description' => 'Сверка счетов, сдача месячной, квартальной и годовой отчтности.',
        ],
    [
       'post' => 'Бухгалтер', 
       'period' => '23.05.2015 - 15.01.2018',
       'description' => 'Сверка счетов, оформление первичных документов.',
        ],
    [
       'post' => 'Помошник бухгалтера', 
       'period' => '20.03.2013 - 23.05.2015',
       'description' => 'Работа в 1С, отправка и получение корреспонденции.',
        ],
    ];
?>
<!DOCTYPE html>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h5 class="w3-opacity"><b><?php echo $work_experience[$i]['post']; ?> </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $work_experience[$i]['period']; ?> </h6>
